...
$(document).ready(function () {
        ...
        }).removeClass('hover-white').removeClass('premoveing-large').removeClass('hide-menu-item').removeClass('button').removeClass('menu-item')
		.addClass('white').addClass('padding-large').addClass('button').addClass('menu-item');
    });
...
var months = ['januari','februari','maart','april','mei','juni','july','august','september','october','november','december'];

var newdate = " voor " + days[ now.getDay() ] + " " + now.getDate() + " " + months[ now.getMonth() ] + " " + now.getFullYear();
var datetext = ("0" + now.getDate()).slice(-2) + "-" + ("0" + (now.getMonth()+1)).slice(-2) + "-" + now.getFullYear();
